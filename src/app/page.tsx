        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative rounded-full px-3 py-1 text-sm/6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
              Calculate CO2 emissions for freight shipments. <a href="#" className="font-semibold text-indigo-600"><span aria-hidden="true" className="absolute inset-0"></span>Learn more <span aria-hidden="true">&rarr;</span></a>
            </div>
          </div>
          <div className="text-center">
            ...
            <p className="mt-8 text-pretty text-lg font-medium text-gray-500 sm:text-xl/8">
              Upload your CSV file with freight shipments and calculate CO2 emissions using the Climatiq API. Validate, process, and export your results.
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              ...
              <a 
                href="/api/emissions/test" 
                target="_blank"
                className="text-sm/6 font-semibold text-gray-900"
              >
                Test API <span aria-hidden="true">→</span>
              </a>
            </div>
          </div>
        </div>
